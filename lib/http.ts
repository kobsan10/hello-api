...
// server names the exact origin and sets Allow-Credentials. Set FRONTEND_ORIGIN to
// the deployed frontend's URL (e.g. https://my-frontend.vercel.app, no trailing
// slash); it defaults to the local Vite dev server.
